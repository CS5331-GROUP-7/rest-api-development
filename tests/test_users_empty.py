...
class TestUsersEmpty(object):
    ...
    def test_users_invalid_token(self):
        response = self.client.post(url_for('views.users'), data=dict(token="b563fdc7-1c1c-46d8-a7a0-42ea1f1d9c4d"))
        assert response.status_code == 200
    ...
    def test_user_register_no_username(self):
        response = self.client.post(url_for('views.users_register'), data=dict(password="2", fullname="3", age="4"))
        assert response.status_code == 200
    ...
    def test_user_register_no_password(self):
        response = self.client.post(url_for('views.users_register'), data=dict(username="1", fullname="3", age="4"))
        assert response.status_code == 200
    ...
    def test_user_register_no_fullname(self):
        response = self.client.post(url_for('views.users_register'), data=dict(username="1", password="2", age="4"))
        assert response.status_code == 200
    ...
    def test_user_register_no_age(self):
        response = self.client.post(url_for('views.users_register'), data=dict(username="1", password="2", fullname="3"))
        assert response.status_code == 200
    ...
    def test_user_authenticate_no_args(self):
        response = self.client.post(url_for('views.users_authenticate'))
        assert response.status_code == 200
    ...
    def test_user_authenticate_no_username(self):
        response = self.client.post(url_for('views.users_authenticate'), data=dict(password="2"))
        assert response.status_code == 200
    ...
    def test_user_authenticate_no_password(self):
        response = self.client.post(url_for('views.users_authenticate'), data=dict(username="1"))
        assert response.status_code == 200
    ...
    def test_user_authenticate_valid_args_no_token(self):
        response = self.client.post(url_for('views.users_authenticate'), data=dict(username="1", password="2"))
        assert response.status_code == 200
    ...
    def test_users_expire_no_token(self):
        response = self.client.post(url_for('views.users_expire'))
        assert response.status_code == 200
    ...
    def test_users_expire_invalid_token(self):
        response = self.client.post(url_for('views.users_expire'), data=dict(token="b563fdc7-1c1c-46d8-a7a0-42ea1f1d9c4d"))
        assert response.status_code == 200
